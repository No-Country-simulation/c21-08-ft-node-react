...
const Cart = ({ changeCartVisibility, isCartVisible, display }: CartProps) => {
  ...
  const positionStyles =
    display === "cart"
      ...
      : "relative mx-auto min-h-[300px] w-full min-w-[460px] sm:min-w-0 bg-transparent"
  ...
  return (
    <>
      ...
      <div
        className={`${isCartVisible ? "flex" : "hidden"} ${positionStyles} z-50 flex-col gap-4 bg-white px-4 py-4 md:w-2/3 sm:w-full xs:gap-2 xs:px-1 xs:py-1`}
      >
        {display === "cart" ? (
